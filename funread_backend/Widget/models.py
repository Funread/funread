...
class WidgetItem(models.Model):
    ...
    value = models.JSONField(db_column='Value', blank=True,  null=True)  # Field name made lowercase.
    type = models.IntegerField(db_column='Type', blank=True,  null=True)  # Field name made lowercase.
    elementorder = models.IntegerField(db_column='ElementOrder', blank=True, null=True)
