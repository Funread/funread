...
function GameModes() {
  ...
  const handleSaveButtonClick = () => {
    // Accedemos al arreglo de respuestas para guardar o utilizar la información
    console.log('Respuestas guardadas:', responses);
        ...
        <div className='col-4' id='modes'>
          ...
          <div>
            <div id='buttonsDifficulty'>
              <button onClick={addEasyResponses}>Easy</button>
            </div>
            <div id='buttonsDifficulty'>
              <button onClick={addInterResponses}>Middle</button>
            </div>
            <div id='buttonsDifficulty'>
              <button onClick={addAdvancedResponses}>Advanced</button>
            </div>
          </div>
          <div id='footerButton' style={{ marginTop: '14em' }}>
            <ButtonNav title={'Next'} />
          </div>
        </div>
