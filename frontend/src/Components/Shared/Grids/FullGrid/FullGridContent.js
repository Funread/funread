...
import "./FullGridContent.css";

const ReactFullGridLayout = WidthProvider(RGL);
...
const Content = (props) => {
  ...
  const [layout, setLayout] = useState([
    ...
    { i: "6", x: 4, y: 1, w: 2, h: 1 }, // Elemento 6, ocupando 2 columnas, en la segunda fila
  ]);
