...
import "./TripleGridHorizontalContent.css";

const ReactGridLayoutTripleGridHorizontal = WidthProvider(RGL);
  ...
  return (
    <div>
      <div ref={drop} style={{ height: "400" }}>
        <ReactGridLayoutTripleGridHorizontal
          className="GridLayoutTripleHorizontal"
